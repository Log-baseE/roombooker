                            ...
                            <li class="list-group-item bdw-0" data-role="task">
                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                    ...
                                    <label for="inputCall2" class=" peers peer-greed js-sb ai-c">
                                        ...
                                        <span class="peer">
                                            <span class="badge badge-pill fl-r badge-success lh-0 p-10">2
                                                Days</span>
                                        </span>
                                    </label>
                                </div>
                            ...
                            <li class="list-group-item bdw-0" data-role="task">
                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                    ...
                                    <label for="inputCall3" class=" peers peer-greed js-sb ai-c">
                                        ...
                                        <span class="peer">
                                            <span class="badge badge-pill fl-r badge-danger lh-0 p-10">3
                                                Minutes</span>
                                        </span>
                                    </label>
                                </div>
                            ...
                            <li class="list-group-item bdw-0" data-role="task">
                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                    ...
                                    <label for="inputCall4" class=" peers peer-greed js-sb ai-c">
                                        ...
                                        <span class="peer">
                                            <span class="badge badge-pill fl-r badge-warning lh-0 p-10">not
                                                important</span>
                                        </span>
                                    </label>
                                </div>
